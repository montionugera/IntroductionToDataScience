...
Redwines with higher quality score (best of this group is 8) tend to have lower 
volatile acidity and lowest quality score have the highest median volatile 
acidity. Volatile acidity variance decreases as the higher quality score.
( worst of this group is 3 ).
...
#                alcohol.median=median(alcohol))
#
#plot_title = "Percent alcohol by volatile.acidity and 
...
low_al_plot <- plot_final_hist(low_al_data,"Low Alcohol Red wines 
Distribution of 
                Potassium sulphase by Wine rating with median lines")

m_low_al_plot <- plot_final_hist(lm_al_data,"Medium-low Alcohol 
Red wines Distribution 
                of Potassium sulphase by Wine rating with median lines")

m_al_plot <- plot_final_hist(m_al_data,"Medium Alcohol Red wines 
Distribution of 
                Potassium sulphase by Wine rating with median lines")
...
### Description Three
From the plot, the excellent quality redwines have highest median 
potassium sulphase and the proportion of excellent redwines are greater in 
medium alcohol level compare to the proportion of redwines in other alcohol 
level.
